  ...
  <div class="container-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav me-auto">
        <?php if ($role === 'admin'): ?>
          <li class="nav-item">
            <a class="nav-link border rounded px-3 py-1 ms-2 text-white hover-gray" href="#">Admin Panel</a>
          </li>
        ...
        <?php elseif ($role === 'student'): ?>
          <li class="nav-item">
            <a class="nav-link border rounded px-3 py-1 ms-2 text-white hover-gray" href="#">My Courses</a>
          </li>
        <?php endif; ?>
      </ul>
